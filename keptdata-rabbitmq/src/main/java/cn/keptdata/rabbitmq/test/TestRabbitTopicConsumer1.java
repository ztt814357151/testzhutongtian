 ...
 */
public class TestRabbitTopicConsumer1 extends RabbitTopicConsumer {



    public TestRabbitTopicConsumer1(List<String> bindingKeys, String exchangeName, String queueName) {
